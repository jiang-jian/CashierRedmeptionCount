...
import 'package:ailand_pos/modules/login/controllers/quick_login_controller.dart';
import 'package:ailand_pos/modules/network_check/controllers/network_check_controller.dart';
...
import '../../presentation/pages/sunmi_customer_api_demo_page.dart';
...
class AppRouter {
  ...
  static GoRouter createRouter() {
    // 如果已经创建过 router,直接返回,避免热更新时重复创建导致 GlobalKey 冲突
    if (_router != null) {
      return _router!;
    }
          ...
          routes: [
            ...
            GoRoute(
              ...
              pageBuilder: (context, state) {
                return CustomTransitionPage(
                  key: state.pageKey,
                  child: const SunmiCustomerApiDemoPage(),
                  transitionsBuilder: _buildPageTransition,
                  transitionDuration: const Duration(milliseconds: 350),
                  reverseTransitionDuration: const Duration(milliseconds: 350),
                );
