/// Sunmi Customer API 演示页面
/// 展示如何使用商米设备系统能力接口

import 'package:flutter/material.dart';
import 'package:ailand_pos/data/services/sunmi_customer_api_service.dart';

class SunmiCustomerApiDemoPage extends StatefulWidget {
  const SunmiCustomerApiDemoPage({super.key});

  @override
  State<SunmiCustomerApiDemoPage> createState() => _SunmiCustomerApiDemoPageState();
}

class _SunmiCustomerApiDemoPageState extends State<SunmiCustomerApiDemoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sunmi Customer API 演示'),
